...
const name = 'advanced-html-editor-blocks/code';

const settings = {
	title: __( 'Code (Advanced HTML Editor Blocks)', 'advanced-html-editor-blocks' ),

	description: __( 'Display code snippets that respect your spacing and tabs.', 'advanced-html-editor-blocks' ),
	...
	edit: ( { attributes, setAttributes, clientId, className } ) => {
		const title = sprintf( __( '%s Block Seetting', 'advanced-html-editor-blocks' ) );
		...
		return (
			<div className={ `wp-block-code advanced-html-editor-blocks-code ${ className }` }>
				{ inspectorControls }
				<CodeEditor
	...
	save: ( { attributes, className } ) => {
		return (
			<div
				className={ `wp-block-code advanced-html-editor-blocks-code ${ className }` }>
