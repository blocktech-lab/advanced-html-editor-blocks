...
const name = 'advanced-html-editor-blocks/html';

const settings = {
	title: __( 'Custom HTML (Advanced HTML Editor Blocks)', 'advanced-html-editor-blocks' ),

	description: __( 'Add custom HTML code and preview it as you edit.', 'advanced-html-editor-blocks' ),
	...
	edit: compose(
		...
		const Content = ( attributes.content ) ? (
			...
			<Placeholder >
				{ __( 'No Content', 'advanced-html-editor-blocks' ) }
			</Placeholder>
		);
		...
		return (
			<div className="wp-block-html advanced-html-editor-blocks-html">
				{ blockControls }
				<Disabled.Consumer>
					{ ( isDisabled ) => (
